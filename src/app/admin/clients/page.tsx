        ...
        <div style={{ maxWidth:'900px', margin:'0 auto', padding:'36px 40px', position:'relative', zIndex:1 }}>
          ...
          <div className="anim-fade" style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:'32px' }}>
            <div>
              ...
              <h1 style={{ fontSize:'26px', fontWeight:800, color:'var(--text)', margin:0 }}>Клієнти</h1>
              <p style={{ fontSize:'13px', color:'var(--text3)', marginTop:'6px' }}>Управління клієнтами та рекламними кабінетами</p>
            </div>
            <Link href="/admin/new-client" style={{ display:'inline-flex', alignItems:'center', gap:'8px', padding:'11px 20px', background:'#e60000', color:'var(--text)', fontSize:'13px', fontWeight:700, borderRadius:'8px', textDecoration:'none', transition:'all 0.15s' }}
          ...
          {loading ? (
            ...
            <div style={{ background:'var(--bg2)', border:'1px solid var(--border)', borderRadius:'12px', padding:'60px 40px', textAlign:'center' }}>
              ...
              <p style={{ fontSize:'13px', color:'var(--text3)', margin:'0 0 24px' }}>Додайте першого клієнта щоб почати</p>
              <Link href="/admin/new-client" style={{ display:'inline-flex', alignItems:'center', gap:'8px', padding:'11px 20px', background:'#e60000', color:'var(--text)', fontSize:'13px', fontWeight:700, borderRadius:'8px', textDecoration:'none' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'10px' }}>
              {clients.map((client,i)=>(
                <div key={client.id} className="anim-up" style={{ background:'var(--bg2)', border:'1px solid var(--border)', borderRadius:'12px', padding:'20px 24px', animationDelay:`${i*50}ms`, transition:'border-color 0.15s' }}
                ...
                >
                  <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between' }}>
                    ...
                    <Link href={`/admin/clients/${client.id}`} style={{ display:'flex', alignItems:'center', gap:'6px', padding:'8px 14px', background:'transparent', border:'1px solid var(--border)', borderRadius:'8px', color:'var(--text3)', fontSize:'12px', cursor:'pointer', transition:'all 0.15s', textDecoration:'none' }}
