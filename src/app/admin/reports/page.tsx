            ...
            <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', flexWrap:'wrap', gap:'10px' }}>
              ...
              <div style={{ display:'flex', gap:'8px', alignItems:'center', flexWrap:'wrap' }}>
                ...
                <div style={{ position:'relative', zIndex:50 }}>
                  ...
                  {showDropdown && (
                    <div style={{ position:'absolute', top:'calc(100% + 6px)', right:0, minWidth:'180px', maxWidth:'calc(100vw - 32px)', background:'var(--bg3)', border:'1px solid var(--border2)', borderRadius:'10px', boxShadow:'0 16px 48px rgba(0,0,0,0.5)', overflow:'hidden', zIndex:100 }}>
                      {clients.map((c,i)=>(
