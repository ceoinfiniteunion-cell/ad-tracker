  ...
  return (
    <aside style={{ width:'220px', minWidth:'220px', background:'#0d0d0d', borderRight:'1px solid rgba(255,255,255,0.05)', display:'flex', flexDirection:'column', height:'100vh', position:'sticky', top:0 }}>
      <div style={{ padding:'20px', borderBottom:'1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ display:'flex', alignItems:'center', gap:'12px' }}>
          <div style={{ width:'36px', height:'36px', background:'rgba(230,0,0,0.12)', border:'1px solid rgba(230,0,0,0.25)', borderRadius:'10px', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
            <svg width="22" height="11" viewBox="0 0 44 22"><ellipse cx="11" cy="11" rx="9" ry="8" fill="none" stroke="#e60000" strokeWidth="2.5"/><ellipse cx="33" cy="11" rx="9" ry="8" fill="none" stroke="#e60000" strokeWidth="2.5"/></svg>
          </div>
          <div>
      ...
      <div style={{ padding:'12px 16px 0', overflow:'hidden' }}>
        <svg width="100%" height="20" viewBox="0 0 188 20" preserveAspectRatio="none"><path d="M0,10 C20,2 40,18 60,10 C80,2 100,18 120,10 C140,2 160,18 188,10" fill="none" stroke="rgba(230,0,0,0.2)" strokeWidth="1.5" strokeDasharray="4 4"/></svg>
      </div>
      ...
      <div style={{ padding:'12px 10px', borderTop:'1px solid rgba(255,255,255,0.05)' }}>
        <Link href="/profile" style={{ display:'flex', alignItems:'center', gap:'10px', padding:'8px 12px', marginBottom:'4px', textDecoration:'none', borderRadius:'8px', transition:'background 0.15s' }} onMouseEnter={e=>{e.currentTarget.style.background='rgba(255,255,255,0.03)'}} onMouseLeave={e=>{e.currentTarget.style.background='transparent'}}>
        ...
        <button onClick={()=>signOut({callbackUrl:'/auth/login'})} style={{ width:'100%', display:'flex', alignItems:'center', gap:'10px', padding:'10px 12px', borderRadius:'8px', fontSize:'13px', color:'rgba(255,255,255,0.3)', background:'transparent', border:'none', cursor:'pointer', transition:'all 0.15s', fontWeight:500 }} onMouseEnter={e=>{e.currentTarget.style.color='#ff4444';e.currentTarget.style.background='rgba(230,0,0,0.08)'}} onMouseLeave={e=>{e.currentTarget.style.color='rgba(255,255,255,0.3)';e.currentTarget.style.background='transparent'}}>
